 ...
 * Encapsula todas las llamadas fetch al endpoint /api/presupuestos con manejo seguro de excepciones.
 */
...
export async function fetchPresupuestos({ clienteId, rol } = {}) {
  try {
    ...
    console.warn('[presupuestosService] Error de red o servidor no disponible:', error.message);
    return [];
  }
}
...
export async function createPresupuesto(datos) {
  try {
    ...
    console.warn('[presupuestosService] Error al crear presupuesto:', error.message);
    throw error;
  }
}
...
export async function updatePresupuesto(id, datos) {
  try {
    ...
    console.warn('[presupuestosService] Error al actualizar presupuesto:', error.message);
    throw error;
  }
}
...
export async function deletePresupuesto(id) {
  try {
    ...
    console.warn('[presupuestosService] Error al eliminar presupuesto:', error.message);
    throw error;
  }
}
